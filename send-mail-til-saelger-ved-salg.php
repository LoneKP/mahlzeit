...
header('Content-type: application/json; charset=UTF-8');
     ...
     require_once 'DBconfig.php';
		...
		if ($emballage_ret_raw < 1) {
			...
			else { $emballage_ret = ('du sørger for emballage');
		}
...
$message = file_get_contents('email-templates/bekraeftelsesmail-til-saelger-ved-salg.html');
...
$message = str_replace('%telefonnummer_ordre%', $telefonnummer_ordre, $message);
...
// Set the subject
$mail->Subject = 'Du har solgt mad via Mahlzeit';
